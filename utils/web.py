...
# Lookup table for common HTML and XML entities
COMMOM_ENTITIES = {
    "&quot;": '"',
    "&apos;": "'",
    "&amp;": "&",
...
def unescape_entities_new(text: str) -> str:
    ...
    def fixup_chars(match: re.Match) -> str:
        ...
        # Look up in the optimized table first
        if entity in COMMOM_ENTITIES:
            return COMMOM_ENTITIES[entity]

        # If not in the lookup table, use the original logic
    ...
    return entity_pattern.sub(fixup_chars, text)
